...
<body>
    ...
    <div id="cetak">
        <div class="row col-md-1">
            ...
            <p align="justify">Bissmillahirrohmaanirohiim Pada <?php echo date('d F Y') . ","; ?> Alhamdulillah telah diterima dana Zakat, Infaq dan Shodaqoh dengan rincian:</p>
            Dokumen Kuitansi Penerimaan:
            <br><br>
